      ...
      success: function (data) {
        ...
        for (let i = 0; i < data.length; i++) {
          ...
          <div class="card" style="width: 18rem;">
            ...
            data[i].price +
            `BAM</p>
              <button type="button" name="button"class="btn btn-primary plan-button" onclick="MembershipPlanService.get(` +
            data[i].id +
            `)">Edit</button>
              <button type="button" name="button"class="btn btn-danger plan-button" onclick="MembershipPlanService.delete(` +
            data[i].id +
            `)">Delete</button>
            </div>
          </div>
