          ...
          <div class="col-lg-3">
            ...
            `</p>
                <div class="btn-group" role="group">
                  <button type="button" class="btn btn-primary user-button" onclick="UserService.get(` +
            data[i].id +
            `)">Edit</button>
                  <button type="button" class="btn btn-danger user-button" onclick="UserService.delete(` +
            data[i].id +
            `)">Delete</button>
                </div>
              </div>
